...
const HomeUser = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (
      !isValidColombianAddress(originAddress) ||
      !isValidColombianAddress(destinationAddress)
    ) {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div>
        <div className="bg-gray-100 h-1/2 w-full flex items-center justify-center mt-6 rounded-lg shadow-md p-4">
